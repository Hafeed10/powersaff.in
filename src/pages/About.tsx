        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-5 text-gray-600 text-base sm:text-lg md:text-base lg:text-lg text-justify md:text-left">
              Electronics is at the heart of modern innovation, shaping the way
              we live, work, and connect with the world. It is the branch of
              science and technology dedicated to the design, development, and
              application of devices and systems that operate using electrical
              circuits. These circuits often incorporate active components such
              as transistors, diodes, and integrated circuits, which work
              together to control and process electrical signals.
            </p>
